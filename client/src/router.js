...
const routes = [
  ...
  { path: '/strategies/compare', name: 'StrategyCompare', component: () => import('./views/StrategyCompare.vue') },
  ...
  { path: '/signals', name: 'MarketSignals', component: () => import('./views/MarketSignals.vue') },
